...
directory="C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/"
...
class facerecognitionsystem:
    def __init__(self, FR_wind):
        ...
        img=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/bg2.jpg")
        ...
        #startMarking
        btnImg2=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/f_det.jpg")
        ...
        std_img_btn1=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/save-icon.png")
        ...
        sub_combo["values"]=("Select Subject","Dummy Attendance","SE Economics","Arabic","NLP","Topics in SE", "Linear Algebra")
        sub_combo.current(0)
    ...
    def markA(self,namelist):
        ...
        if sub!="Select Subject":
            ...
            if (wb.save("C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Attendance/sheet_"+sub+".xlsx")):
    ...
    def facerecognize(self):
            path = 'C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/ImagesOfFaces'
            images = []
            classNames = []
