...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/loginBg1.jpg")
        ...
        img1=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/log1.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(host="localhost",username="root",password="hoang",database="face")
