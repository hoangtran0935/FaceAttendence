...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:/Users/Dell.MM/hoang/ace_recognition_attendance_system/FRAS/Images_GUI/bg2.jpg")
    ...
    def fetch_Data(self):
            conn = sq.connect(host="localhost",username="root",password="hoang",database="face")
