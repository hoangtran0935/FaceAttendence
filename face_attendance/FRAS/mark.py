...
class FaceDetect:
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/Train.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/bg2.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Images_GUI/f_det.jpg")
            ...
            for col in range(2,3):
                ...
                for i in namelist:
                    if i==val:
                        ...
                        c1 = ws.cell(row, column)
                        c1.value = "P" 
        wb.save("C:/Users/Dell.MM/hoang/face_recognition_attendance_system/FRAS/Attendance/sheet3.xlsx")
